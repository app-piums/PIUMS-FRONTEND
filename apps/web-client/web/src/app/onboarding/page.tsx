...
function StepVerification({
  ...
  const UploadBox = ({
    label, hint, folder, uploading, preview, errorKey, setUploading, setUrl, setPreview, optional,
  }: {
    label: string; hint: string; folder: 'front' | 'back' | 'selfie';
    uploading: boolean; preview: string; errorKey: string;
    ...
    <div>
      ...
      {preview ? (
        ...
        <label className={`flex cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed px-4 py-5 transition-colors ${
          errors[errorKey] ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-[#FF6A00]/50 hover:bg-orange-50/30'
        }`}>
          {uploading
    ...
    <div className="flex-1 flex flex-col px-6 py-8 max-w-2xl mx-auto w-full piums-fade-in">
      ...
      <div className="space-y-5 mb-8">
        ...
        <UploadBox
          ...
          folder="front" uploading={uploadingFront} preview={frontPreview} errorKey="documentFront"
        ...
        {documentType === 'DPI' && (
          <UploadBox
            ...
            folder="back" uploading={uploadingBack} preview={backPreview} errorKey="documentBack"
        ...
        <UploadBox
          ...
          folder="selfie" uploading={uploadingSelfie} preview={selfiePreview} errorKey="documentSelfie"
