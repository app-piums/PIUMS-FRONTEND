...
const CLIENT_APP_URL = process.env.NEXT_PUBLIC_CLIENT_URL || "http://127.0.0.1:3000";
  ...
  return (
    <footer style={{ background: "#050505", borderTop: "1px solid rgba(255,255,255,0.05)", color: "#fafafa", position: "relative", overflow: "hidden" }}>
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-16" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-14">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm font-medium mb-5" style={{ color: "rgba(255,255,255,0.55)" }}>
              Tu negocio creativo, en un solo lugar.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "Crear mi perfil gratis", href: "/register/artist" },
                { label: "Iniciar sesión", href: "/login" },
                { label: "Cómo funciona", href: "/login" },
                { label: "Panel de artista", href: "/login" },
              ].map(({ label, href }) => (
                <li key={label}>
        ...
        >
          <div>
            <p className="text-sm font-semibold mb-0.5">Descarga Piums for Artists</p>
            <p className="text-xs" style={{ color: "rgba(255,255,255,0.35)" }}>
              Gestiona reservas y cobros desde tu móvil. Disponible para iOS y Android.
            </p>
          </div>
          <div className="flex items-center gap-3 shrink-0">
            <a
              href={process.env.NEXT_PUBLIC_ARTIST_APP_IOS || "#"}
              target="_blank"
            ...
            <a
              href={process.env.NEXT_PUBLIC_ARTIST_APP_ANDROID || "#"}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl transition-opacity hover:opacity-80"
              style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.08)" }}
